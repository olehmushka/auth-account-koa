...
export class SessionService extends SessionToolkit {
  ...
  public async createSession(data: SessionData | string, token: string): Promise<models.Session | Error> {
    try {
  ...
  public async getSession(data: SessionData | string): Promise<models.Session | Error> {
    try {
  ...
  public async destroySession(data: SessionData | string): Promise<void | Error> {
    try {
      typeof data === 'string'
